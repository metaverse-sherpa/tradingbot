  ...
  return (
    <div className="flex-1 w-full max-w-5xl mx-auto space-y-8 p-4 md:p-8">
      ...
      <div className="bg-[#1b1f2c]/70 backdrop-blur-xl border border-white/10 rounded-2xl p-6 md:p-8 shadow-lg">
        <h2 className="text-2xl font-bold text-white mb-6">How does the Valkyrie Elite Scalper strategy minimize drawdown?</h2>
        ...
        <img src="/api/charts/valkyrie_elite_infographic_ai.webp" alt="Valkyrie Elite Infographic" width={1024} height={1024} className="w-full aspect-square rounded-xl border border-white/10 mb-8" onError={(e) => e.currentTarget.style.display = 'none'} />

        <div className="bg-[#0b0e14]/40 p-6 rounded-xl border border-white/5">
          <div className="flex items-center gap-2 mb-2">
            <History size={18} className="text-[#3cd7ff]" />
            <h2 className="text-xl font-bold text-white">What is the win rate of the Valkyrie Elite Scalper strategy?</h2>
          </div>
          ...
          {stat && (
            <div className="bg-[#1b1f2c]/50 rounded-xl p-5 mt-6 border border-white/5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-sm font-bold text-cyan-400 uppercase tracking-wider">Live Alpha Stats</h3>
              </div>
          ...
          <div className="mt-8 pt-6 border-t border-white/10 text-center">
            ...
            <p className="text-xs text-gray-400 mt-3">Full access to Valkyrie Elite Scalper is included in the Premium subscription.</p>
          </div>
        </div>
      </div>
    </div>
